...
public class S_BroadcastEnterGame : IPacket
{
    ...
    public void Read(ArraySegment<byte> segment)
    {
		...
		count += sizeof(float);
		this.rotationX = BitConverter.ToSingle(segment.Array, segment.Offset + count);
		count += sizeof(float);
		this.rotationY = BitConverter.ToSingle(segment.Array, segment.Offset + count);
		count += sizeof(float);
		this.rotationZ = BitConverter.ToSingle(segment.Array, segment.Offset + count);
		count += sizeof(float);
    ...
    public ArraySegment<byte> Write()
    {
		...
		count += sizeof(float);
		Array.Copy(BitConverter.GetBytes(this.rotationX), 0, segment.Array, segment.Offset + count, sizeof(float));
		count += sizeof(float);
		Array.Copy(BitConverter.GetBytes(this.rotationY), 0, segment.Array, segment.Offset + count, sizeof(float));
		count += sizeof(float);
		Array.Copy(BitConverter.GetBytes(this.rotationZ), 0, segment.Array, segment.Offset + count, sizeof(float));
		count += sizeof(float);
