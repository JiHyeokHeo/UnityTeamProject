    ...
    public class GameRoom
    {
        ...
        public void HandleMove(Player player, C_Move movePacket)
        {
            ...
            lock (_lock)
            {
                ...
                {
                    if (_map.CanGo(new Vector3Int(movePosInfo.PosX, movePosInfo.PosY, movePosInfo.PosZ)) == false)
                        return;
                }

                info.PosInfo.State = movePosInfo.State;
                info.PosInfo.MoveDir = movePosInfo.MoveDir;
                _map.ApplyMove(player, new Vector3Int(movePosInfo.PosX, movePosInfo.PosY, movePosInfo.PosZ));
